...
set "bat_ver=RenameSubtitles RE: Ver1.1 UTF-8"
...
if defined diff_end set /a diff_in=diff_in+1
...
for /l %%a in (0,1,9) do (
	if not defined non_numerical if "%numSingle%"=="%%~a" set "non_numerical=0"
)
goto :EOF
